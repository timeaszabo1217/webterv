...
<head>
    ...
    <style>
        body {
            background-image: url("assets/img/galeria_bg.png");
...
<nav id = "navbar">
    ...
    <a class = "active" href = "galeria.php">Galéria</a>
    <a id = "profileIcon" href = "profil.php">
        <img src = "assets/img/profile_icon.png" alt = "profil">
    </a>
</nav>

<div id = "galeria" class = "fadeIn">
    <h3>Galéria</h3>
    <p>Itt bepillantást kaphatsz a Calm Fauna életébe. Igyekszünk mindig újítani és fejlödni, ez meglátszik üzletünkön is.
    Nézz be hozzánk személyesen is, nem bánod meg.</p>
    <p>(A képen szereplő személyek mind beleegyeztek a fotó elkészültébe)</p>
    <div id = "images">
        <img class = "galeria" src = "assets/img/1.jpg" alt ="kép">
        <img class = "galeria" src = "assets/img/2.jpg" alt ="kép">
        <img class = "galeria" src = "assets/img/3.jpg" alt ="kép">
        <img class = "galeria" src = "assets/img/4.jpg" alt ="kép">
        <img class = "galeria" src = "assets/img/5.jpg" alt ="kép">
        <img class = "galeria" src="assets/img/6.jpg" alt ="kép">
    </div>
</div>
